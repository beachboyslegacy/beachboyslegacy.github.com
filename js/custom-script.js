            ...
            $thisItem = '<li id="'+data.items[i].parent.uniqueId+'" data-rating="'+data.items[i].parent.aggregateRating+'" data-date="'+data.items[i].parent.releaseYear+'">'+
              ...
              for (k=0; k<tracks; k++){
                ...
                if( data.items[i].parent.tracklist[k].hit == true ){
                  thisTrack = '<tr>'+
                                    '<td><div class="tracknumber">'+data.items[i].parent.tracklist[k].track+'</div>'+data.items[i].parent.tracklist[k].name+'</td>'+
                                  ...
                                  '</tr>'
                }else if( data.items[i].parent.tracklist[k].inthit == true ){
                  thisTrack = '<tr>'+
                                    '<td><div class="tracknumber">'+data.items[i].parent.tracklist[k].track+'</div>'+data.items[i].parent.tracklist[k].name+'</td>'+
